...
- Ymse småforbedringer.
- **Arkiv**: observasjoner slettes ikke lenger for godt – **Arkiver**-knappen (før
  «Slett») flytter dem til arkivet. **Arkiv**-lenka nederst i appen åpner det, og der
  kan du markere og gjenopprette dem.
- Lange lister viser en tynn rulleindikator i høyrekanten mens du blar, så du ser
  hvor langt ned du er.
- Tryggere lagring: observasjonene dine kan ikke lenger gå tapt om appen krasjer
  midt i en lagring.
