...
object Strings {
    ...
    object About {
        ...
        const val artsdatabanken = "Rödlistestatus från SLU Artdatabanken (CC0)"
        const val alienRisk = "Främmande arter från SLU Artdatabanken (CC0)"
    ...
    object Time {
        const val title = "Tid"
        const val from = "Starttid"
        const val to = "Sluttid"
        const val now = "Nu"
        const val done = "Klar"
        const val noTime = "Utan klockslag"
    }
