...
object Strings {
    ...
    object About {
        ...
        const val artsdatabanken = "Rødliste fra Artsdatabanken (CC BY 4.0)"
        const val alienRisk = "Fremmedarter fra Artsdatabanken (CC BY 4.0)"
